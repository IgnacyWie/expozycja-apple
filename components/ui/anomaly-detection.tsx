...
const AnomalyDetection = ({
  ...
  cardDescription = "MantAI compares each recording against learned sound signatures, flags abnormal patterns early, and assigns a confidence score so you know which component is at risk before it fails.",
  ...
  return (
    <div
      className={cn(
        ...
        "rounded-2xl border border-neutral-800 bg-black",
      )}
    >
