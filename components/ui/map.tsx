                  ...
                  >
                    <foreignObject x={startPoint.x - 50} y={startPoint.y - 35} width="100" height="30" className="block">
                      <div className="flex h-full items-center justify-center">
                        <span
                          className={`rounded-md border border-gray-200 bg-white/95 px-2 py-0.5 text-sm font-medium text-black shadow-sm dark:border-gray-700 dark:bg-black/95 dark:text-white ${labelClassName}`}
                        >
                          {dot.start.label}
                        </span>
                      </div>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="pointer-events-none absolute bottom-4 left-4 rounded-lg border border-gray-200 bg-white/90 px-3 py-2 text-sm font-medium text-black shadow-sm backdrop-blur-sm dark:border-gray-700 dark:bg-black/90 dark:text-white sm:hidden"
          >
            {hoveredLocation}
          </motion.div>
        )}
