...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'm-0.5 rounded-full bg-muted group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1 group-data-[orientation=horizontal]/stepper-nav:min-w-[40px]',
        'group-data-[orientation=horizontal]/stepper-nav:data-[state=completed]:bg-primary group-data-[orientation=horizontal]/stepper-nav:transition-colors',
        className,
      )}
    />
  );
