...
export function Features() {
  return (
    <section id="features" className="scroll-mt-24 bg-gray-50 py-16 md:py-32 dark:bg-transparent">
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">

            {/* Top Left: 99.4% Accuracy */}
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold tracking-tighter">99.4%</span>
                </div>
                <div className="mt-6 flex flex-col items-center">
                  <h2 className="text-center text-3xl font-semibold">
                    Accuracy<sup className="ml-1 text-sm font-normal text-muted-foreground">1</sup>
                  </h2>
                  <p className="mt-2 max-w-[200px] text-center text-xs leading-relaxed text-muted-foreground">
                    Precision identification of every loaf across all conditions.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Top Middle: Privacy by Design */}
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <Shield className="m-auto size-12 text-zinc-400 dark:text-zinc-600" strokeWidth={1} />
                </div>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Real-time data from every counter snap, instantly aggregated.</p>
                </div>
              </CardContent>
            </Card>

            {/* Bottom Left: Zero-Waste Baking */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <LineChart className="m-auto size-5 text-zinc-400" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-zinc-800 transition dark:text-white">
                      Global Oversight
                    </h2>
                    <p className="text-sm text-muted-foreground">See every counter in your empire from one screen. Real-time visibility into stock levels across all locations, no matter where you are.</p>
                  </div>
                </div>
                <div className="rounded-tl-[var(--radius)] relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Automated alerts for your front-of-house when trays need replenishment.</p>
                  </div>
                </div>
                <div className="before:bg-[var(--color-border)] relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-[10px] font-medium shadow-sm">Head Baker</span>
                      <div className="ring-background size-7 ring-4">
                        <img
                          className="size-full rounded-full object-cover"
                          src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=160&q=80"
                          alt="Head Baker avatar"
                        />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      ...
                      <span className="block h-fit rounded border px-2 py-1 text-[10px] font-medium shadow-sm">Store Mgr</span>
                    </div>
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-[10px] font-medium shadow-sm">Owner</span>
                      <div className="ring-background size-7 ring-4">
                        <img
                          className="size-full rounded-full object-cover"
          ...
          {/* Footnote for the entire section */}
          <div className="mt-8 px-2">
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              1. Verified across all bakery counter models, display layouts, and varied lighting conditions.
            </p>
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              2. Data privacy architecture ensures PII is never stored or processed.
            </p>
          </div>
