          ...
          options={{
            ...
            particles: {
              ...
              color: {
                ...
                animation: {
                  h: { enable: false, speed: 1, sync: true, count: 0, decay: 0, delay: 0, offset: 0 },
                  s: { enable: false, speed: 1, sync: true, count: 0, decay: 0, delay: 0, offset: 0 },
                  l: { enable: false, speed: 1, sync: true, count: 0, decay: 0, delay: 0, offset: 0 },
                },
              },
